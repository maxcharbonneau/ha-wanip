# Getting Started with WANIP

This guide will help you install and set up the WANIP custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/maxcharbonneau/ha-wanip`
6. Set category to "Integration"
7. Click "Add"
8. Find "WANIP" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/maxcharbonneau/ha-wanip/releases)
2. Extract the `wanip` folder from the archive
3. Copy it to `custom_components/wanip/` in your Home Assistant configuration directory
...
- Report issues at [GitHub Issues](https://github.com/maxcharbonneau/ha-wanip/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/maxcharbonneau/ha-wanip/discussions)
