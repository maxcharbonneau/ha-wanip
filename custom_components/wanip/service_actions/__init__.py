"""Service actions package for wanip."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.wanip.const import DOMAIN, LOGGER
from custom_components.wanip.service_actions.example_service import (
