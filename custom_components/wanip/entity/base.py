...
from custom_components.wanip.const import ATTRIBUTION
...
class WANIPEntity(CoordinatorEntity[WANIPDataUpdateCoordinator]):
    """
    Base entity class for wanip.
