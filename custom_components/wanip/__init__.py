"""
Custom integration to integrate wanip with Home Assistant.
...
https://github.com/maxcharbonneau/ha-wanip
...
from .data import WANIPData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import WANIPConfigEntry
