"""
Core DataUpdateCoordinator implementation for wanip.
...
from custom_components.wanip.api import WANIPApiClientAuthenticationError, WANIPApiClientError
from custom_components.wanip.const import LOGGER
...
class WANIPDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except WANIPApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="wanip",
                translation_key="authentication_failed",
            ) from exception
        except WANIPApiClientError as exception:
