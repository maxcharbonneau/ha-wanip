...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=ha-wanip&category=integration)
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=wanip)
...
Find all entities in **Settings** → **Devices & Services** → **WANIP** → click on the device.
...
4. Check the integration diagnostics (Settings → Devices & Services → WANIP → 3 dots → Download diagnostics)
