...
- **Title:** WANIP
- **Class prefix:** `WANIP`
- **Main code:** `custom_components/wanip/`
...
- `entity/` — Base entity class (`WANIPEntity`)
...
- Entity MRO: `(PlatformEntity, WANIPEntity)` — order matters
...
- Debug level: `custom_components.wanip: debug` in `config/configuration.yaml`
