...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `WANIP`
...
- Inherit from both platform entity and `WANIPEntity` (order matters)
...
from custom_components.wanip.sensor import async_setup_entry
...
**Config entry data:** `entry_data: WANIPData = hass.data[DOMAIN][entry.entry_id]`
