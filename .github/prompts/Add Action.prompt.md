...
**File:** `custom_components/wanip/services.yaml`
...
Create `custom_components/wanip/service_actions/[action_name].py`:

```python
"""[Action name] service action for WANIP."""
...
**File:** `custom_components/wanip/__init__.py`
...
**File:** `custom_components/wanip/const.py`
...
3. Find service action: `wanip.[action_name]`
...
- **Domain:** `wanip`
- **Service actions directory:** `custom_components/wanip/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/wanip/services.yaml` (legacy filename)
- **Icons:** `custom_components/wanip/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/wanip/translations/*.json` under `services` key (legacy)
