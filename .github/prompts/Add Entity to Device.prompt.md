...
- Inherit from `WANIPEntity` and platform base class
...
- Entity: `custom_components/wanip/[platform]/[entity_name].py`
- Platform: `custom_components/wanip/[platform]/__init__.py`
