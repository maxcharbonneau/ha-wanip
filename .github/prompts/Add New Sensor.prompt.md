...
- Create new sensor file in `custom_components/wanip/sensor/`
- Inherit from `WANIPEntity` and `SensorEntity`
...
- Entity: `custom_components/wanip/sensor/[sensor_name].py`
- Platform: `custom_components/wanip/sensor/__init__.py`
- Translations: `custom_components/wanip/translations/*.json`
